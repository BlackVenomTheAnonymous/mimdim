<?php
//==============[CC CHECKER BOT API MADE BY 𓆩𝗫𝗲𝗿𝗿𝗼𝘅𓆪「Zone ↯」]================//

//=======[Webhook]========https://api.telegram.org/bot6214931297:AAF_JsMX5QyLMqWLf4iWO9ENapCu7RfImks/setwebhook?url=<url>

//================[Telegram BOT API TOKEN ]================//
$botToken = "6214931297:AAF_JsMX5QyLMqWLf4iWO9ENapCu7RfImks"; #<------------------- PUT YOUR TOKEN HERE------------->#
...
sendMessage($chatId, '<b>🟢Valid Bin :- </b>'.$bin.'%0A<b>✦ Bank:</b> '.$bank.'%0A<b>✦ Country:</b> '.$name.''.$emoji.'%0A<b>✦ Brand:</b> '.$brand.'%0A<b>✦ Card:</b> '.$scheme.'%0A<b>✦ Type:</b> '.$type.'%0A<b>▬▬▬▬▬▬▬▬▬▬▬▬▬▬</b>%0A<b>✦ CHECKED BY -</b>: @'.$username.'%0A<b>✦ BOT BY</b>:<a> 𓆩𝗫𝗲𝗿𝗿𝗼𝘅𓆪「Zone ↯」</a>', $message_id);
}
//=========[Bin Command-END]=========//
...
sendMessage($chatId, "✦ Chat [ID]: <code>$chatId</code>%0A✦ Name: $firstname%0A✦ Username: @$username%0A%0A✦<b>Bot Made by: 𓆩𝗫𝗲𝗿𝗿𝗼𝘅𓆪「Zone ↯」 </b>");
}
//=========[Info Command-END]=========//
